$(document).ready(function() {
    ...
    $("button[dialog-target]").click(function(){
    ...
    $("button[dialog-close-target]").click(function(){
    ...
    $(".dialog").close = function(){
        $(this).children(".dialog-content-fade").fadeOut(200);
        setTimeout(function(){$(this).fadeOut();}, 200);
    };
